#!/usr/bin/env python3
# ═══════════════════════════════════════════════════════════════════════════════
#  bot.py — Sentinel Polymarket v8.4  "Aggressive: more signals, more activity"
# ───────────────────────────────────────────────────────────────────────────────
...
# ───────────────────────────────────────────────────────────────────────────────
#  CAMBIOS v8.4 vs v8.3 (más agresivo, más señales):
#    1. EV_NORMAL:        3.5% → 3.0%
#    2. BAYES_NORMAL:     55%  → 52%
#    3. MIN_LIQUIDITY:    $50  → $30
#    4. Rangos de duración relajados:
#         1h:  45–80   →  40–90   min
#         4h:  180–300 →  160–320 min
# ───────────────────────────────────────────────────────────────────────────────
#  ⚠️ ADVERTENCIA SOBRE LIVE MODE:
#  Filtros más laxos = más señales pero MENOR calidad media por señal.
#  Validar primero en paper: ≥30 trades resueltos (no EXPIRED) con WR ≥ 52%
#  ANTES de cambiar PAPER_MODE=false. Si WR sale ~50% el modelo no tiene edge.
# ───────────────────────────────────────────────────────────────────────────────
...
def main():
    ...
    while True:
        try:
            ...
            tg.stop()
            tg.send("🛑 Sentinel v8.4 detenido manualmente.")
            discord("🛑 Sentinel v8.4 detenido manualmente.")
            break
